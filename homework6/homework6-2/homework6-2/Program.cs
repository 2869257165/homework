...
namespace homework6_2
{
    ...
    {
        public static string xmlfilename = "sx.xml";
        public XmlSerializer xmlser = new XmlSerializer(typeof(List<Order>));
        ...
        //按订单号查询订单
        public bool finbyID(int number)
        {
            bool t = false;
            var m = from n in orders where n != null select n;
            foreach (var i in m)
        ...
        public void Import()
        {
            List<Order> orders2 = XmlDeserialize(xmlser, xmlfilename) as List<Order>;

        }
        public object XmlDeserialize(XmlSerializer ser, string filename)
        {
        ...
        public void XmlSerialize(XmlSerializer ser, string filename, object obj)
        {
